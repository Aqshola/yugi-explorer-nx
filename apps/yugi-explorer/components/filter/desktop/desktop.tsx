...
export function Desktop(props: DesktopProps) {
  ...
  return (
    <div
      className={
        'transition-all px-5 md:px-14  items-center gap-5 sticky top-0 hidden md:flex  pb-5 ' +
        (sticky ? ' backdrop-blur-lg z-50 bg-blue-primary/70' : ' ')
      }
    >
      <div className="hidden md:block">
        <label htmlFor="search" className="text-3xl text-white font-grenze">
          Search Card
        </label>
        <div className="bg-blue-dark rounded-3xl flex p-3 mt-2 w-72 items-center gap-5">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
